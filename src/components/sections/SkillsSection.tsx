  ...
  <section id="skills" className="section-padding">
    <div className="mx-auto max-w-screen-xl space-y-12 px-6">
      <SectionHeading
        ...
        title="Capabilities built for reliability and long-term ownership"
        description="Focused on system clarity, product delivery, and durable platform decisions."
      />
      <div className="grid gap-6 md:grid-cols-2">
        {groups.map((group, index) => (
          <MotionReveal key={group.title} delay={index * 0.05} className={cardStyles}>
